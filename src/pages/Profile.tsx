...
import { PublicProfile, SocialPost } from '@/services/social'
...
export default function Profile() {
  ...
  const cleanParam = usernameParam?.replace(/^@/, '').toLowerCase()
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in-up pb-16">
      {/* Top Bar for non-own profile */}
      {!isOwnProfile && (
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="p-2 rounded-2xl hover:bg-muted border-2 transition-all">
      ...
      <div className="bg-card rounded-3xl border-2 shadow-sm overflow-hidden">
        ...
        <div className="px-5 sm:px-6 pb-6">
            ...
            <div className="flex items-center gap-2">
              {isOwnProfile ? (
                <button
                  ...
                  className="px-4 py-2 rounded-2xl bg-muted hover:bg-muted/80 border-2 font-black text-xs transition-all active:translate-y-0.5"
                >
                  Editar Perfil
                </button>
              ) : (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-2xl font-black text-xs transition-all active:translate-y-0.5 ${
          ...
          {/* Counters - Duolingo 3D mini buttons */}
          <div className="grid grid-cols-3 gap-2 sm:gap-3 mt-6">
            <button
              onClick={handleOpenFollowers}
              className="bg-muted/50 hover:bg-muted border-2 rounded-2xl p-3 text-center transition-all active:translate-y-0.5"
            >
        ...
        {profilePosts.length === 0 ? (
          <div className="bg-card rounded-3xl border-2 p-8 text-center space-y-3">
            ...
            {isOwnProfile && (
              <Link
                to="/social"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-[#58CC02] hover:bg-[#58CC02]/90 border-b-4 border-[#46A302] text-white font-black text-xs active:translate-y-0.5"
              >
                Ir para o Feed
              </Link>
            )}
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  {isOwnProfile && (
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <button className="p-1.5 rounded-xl hover:bg-muted text-muted-foreground">
