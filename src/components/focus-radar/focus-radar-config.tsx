...
export function FocusRadarConfig({
  ...
  const [message, setMessage] = useState(adaSettings.message)
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px] rounded-3xl p-6">
        <DialogHeader>
          <DialogTitle className="text-2xl font-extrabold">Ada Focus</DialogTitle>
          <DialogDescription className="font-semibold">
            Lembretes periódicos para manter a presença e foco.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-sm">
                  Ada Focus {adaSettings.enabled ? 'Ativo' : 'Inativo'}
                </p>
              ...
              {INTERVALS.map((min) => (
                <button
                  ...
                  className={cn(
                    ...
                    adaSettings.intervalMinutes === min
              ...
              {SOUNDS.map((sound) => (
                <button
                  ...
                  className={cn(
                    ...
                    adaSettings.soundProfile === sound.value
